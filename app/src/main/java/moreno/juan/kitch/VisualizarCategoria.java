...
public class VisualizarCategoria extends AppCompatActivity  {
    ...
    public void onCreate(Bundle savedInstanceState, @Nullable PersistableBundle persistentState) {
        ...
        recyclerViewRecetas = (RecyclerView) findViewById(R.id.recicler_categorias_recet);
        nombre_categoria = (TextView) findViewById(R.id.text_categorias_rec);
            ...
            public boolean onInterceptTouchEvent(RecyclerView recyclerView, MotionEvent motionEvent) {
                try {
                    ...
                    if (child != null && mGestureDetector.onTouchEvent(motionEvent)) {
                        ...
                        warningMensaje("EERRROR","AAAAAAAAAAA","FK").show();
